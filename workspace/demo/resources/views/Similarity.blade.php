    ...
    <div class="entry-wrapper" style="float: left">
      <div class="entry-content">
        <div id="chart" style="width: 100%; margin: 0px auto; position: relative;"></div>
          <p style="color:black; font-size: 100%; text-align: center;">This chord diagram shows pairwise similarity between the result and all documents in our full-text search system.</p>
<style>
#circle circle {
  fill: none;
  pointer-events: all;
